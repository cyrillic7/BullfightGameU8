...
//扑克数据
const BYTE GameLogicHundred::m_cbCardListData[54]=
{
...
//混乱扑克
void GameLogicHundred::RandCardList(BYTE cbCardBuffer[], BYTE cbBufferCount)
{
	//混乱准备
...
void GameLogicHundred::RandCardListEx(BYTE cbCardBuffer[], BYTE cbBufferCount)
{
...
int GameLogicHundred::RetType(int itype)
{
	itype = itype%10;
	switch(itype)
	{
...
//获取牌型
BYTE GameLogicHundred::GetCardType(const BYTE cbCardData[], BYTE cbCardCount,BYTE *bcOutCadData )
{
	//合法判断
...
*/
//Multiple 比较出来的倍数
int GameLogicHundred::CompareCard(const BYTE cbFirstCardData[], BYTE cbFirstCardCount,const BYTE cbNextCardData[], BYTE cbNextCardCount,BYTE &Multiple)
{
	//合法判断
...
//获取牌点
BYTE GameLogicHundred::GetCardListPip(const BYTE cbCardData[], BYTE cbCardCount)
{
	//变量定义
	BYTE cbPipCount=0;
...
BYTE GameLogicHundred::GetCardNewValue(BYTE cbCardData)
{
	//扑克属性
...
//逻辑大小
BYTE GameLogicHundred::GetCardLogicValue(BYTE cbCardData)
{
...
//排列扑克
void GameLogicHundred::SortCardList(BYTE cbCardData[], BYTE cbCardCount, BYTE cbSortType)
{
	//数目过虑
